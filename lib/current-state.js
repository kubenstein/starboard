...
export default class CurrentState {
  constructor(params) {
    ...
    this.eventHandlers = {
      columnAdded: ColumnAddedEventHandler,
      columnUpdated: ColumnUpdatedEventHandler,
      cardAdded: CardAddedEventHandler,
      cardUpdated: CardUpdatedEventHandler,
      cardRemoved: CardRemovedEventHandler,
      commentAdded: CommentAddedEventHandler,
      commentRemoved: CommentRemovedEventHandler,
    };
